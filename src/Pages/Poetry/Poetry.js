...
const Poetry = props => {
    ...
    return (
        <div>
            ...
            <CustomModal display={ShowNormalPoem} click={displayNormalPoem} text={NewNormalPoemText} title="The New Normal" />
            <CustomModal display={ShowCoronavirusSpringPoem} click={displayCoronavirusSpringPoem} text={CoronavirusSpringPoemText} title="Coronavirus Spring" />
            <CustomModal display={showNursesPoem} click={displayNursesPoem} text={NurseCoronavirusPoemText} title="Thank you to the Nurses" />
            <CustomModal display={showNewDayPoem} click={displayNewDayPoem} text={NewDayPoemText} title="New Day" />
            <CustomModal display={showHaircutPoem} click={displayHaircutPoem} text={haircutPoemText} title="Coronavirus Haircut" />
